...
counting and hashing. Batch boundaries remain the same as `run` because Unicorn
classifications must be reproducible across both paths. Full-sweep concurrency
comes from running independent shards in parallel, not changing those boundaries.
