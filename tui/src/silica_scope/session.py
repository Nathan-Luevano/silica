...
class Session:
    ...
    def has_anything(self) -> bool:
        # a stray verification metadata one directory up is not an artifacts tree.
    ...
    def problems(self) -> list[str]:
        ...
        if self.goals_error and self.goals_error != "verification metadata not found":
            out.append(f"verification metadata: {self.goals_error}")
