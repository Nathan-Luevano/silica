...
See architecture notes for the full design and build manual. This project is
in progress: `verification metadata` and `silica verify` are the only source of truth
